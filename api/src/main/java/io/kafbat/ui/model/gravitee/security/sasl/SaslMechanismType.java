...
public enum SaslMechanismType {
  ...
  GSSAPI("GSSAPI"),
  /**
   * The SASL/OAUTHBEARER mechanism enables the use of the framework in a SASL (i.e. a non-HTTP) context;
   * it is defined in RFC 7628.
   */
  ...
  PLAIN("PLAIN"),
  /**
   * SASL/SCRAM is a family of SASL mechanisms that addresses the security concerns
   * with traditional mechanisms that perform username/password authentication like PLAIN.
   */
